        ...
        <div className='sticky top-0 z-50 bg-white flex items-center p-2 lg:px-5 shadow-md'>
            ...
            <div className='flex items-center'>
                <Image src="https://links.papareact.com/5me"
                    width={40} height={40} layout="fixed" alt=""
                />
            </div>
            ...
            <div className='flex items-center sm:space-x-2 justify-end'>
                {/**Profile image */}
                <Image onClick={signOut} className='rounded-full cursor-pointer' src='https://i1.sndcdn.com/avatars-000130000038-ro6g90-t240x240.jpg' width='40' height='40' layout='fixed' alt="" />
